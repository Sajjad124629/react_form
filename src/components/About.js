...
const About = () => {
    ...
    const [myenablebutton,setMyenablebutton] = useState('Enable Dark Mode')
    const toggole = ()=>{
        if(mystyle.color ==='black'){
            ...
            setMyenablebutton('Enable Light Mode')
        }
        else{
            setMystyle({
                color: 'black',
            ...
            setMyenablebutton('Enable Dark Mode')
        }
    }
    ...
    return (
         ...
         <div className='' style={mystyle} >
             <h1>About Us</h1>
         <div className="accordion pb-5" id="accordionExample" style={mystyle}>
    ...
    <div id="collapseThree" style={mystyle} className="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
      <div className="accordion-body">
        <strong>This is the third item's accordion body.</strong> It is hidden by default, until the collapse plugin adds the appropriate classes that we use to style each element. These classes control the overall appearance, as well as the showing and hiding via CSS transitions. You can modify any of this with custom CSS or overriding our default variables. It's also worth noting that just about any HTML can go within the <code>.accordion-body</code>, though the transition does limit overflow.
         ...
         <button onClick={toggole} className='btn btn-primary my-2'>{myenablebutton}</button>
         </div>
